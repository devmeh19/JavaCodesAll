    ...
    else
    {
        ...
        else
        {
            ...
            if (flag == 1 && created_node -> fill_room != 0)
            {
               ...
               strcpy(created_node->name[i], created_node->name[i+ 1]); 
                created_node -> fill_room--;
                created_node -> room_capacity++;
                  }
                }
                  else if(created_node->fill_room==3)
                {
              if(i==2)
                {
                created_node -> name[i][0] = 'A';
             ...
             strcpy(created_node->name[i], created_node->name[i+ 1]);
                ...
                created_node -> room_capacity++;
                          ...
                          strcpy(created_node->name[0], created_node->name[1]);
                        strcpy(created_node->name[1], created_node->name[2]);
                created_node -> fill_room--;
                created_node -> room_capacity++;
                  }
                }
